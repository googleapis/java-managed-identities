  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "api/resource.proto\0320google/cloud/managedidentities/v1/resource.proto\032#google/longrunning/operations.proto\032"
          + " google/protobuf/field_mask.proto\032\037google/protobuf/timestamp.proto\"\334\001\n\n"
          + "OpMetadata\0224\n"
          ...
          + "\'managedidentities.googleapis.com/Domain\022<\n"
          + "\005trust\030\002"
          + " \001(\0132(.google.cloud.managedidentities.v1.TrustB\003\340A\002\"\223\001\n"
          ...
          + "\027CreateMicrosoftAdDomain\022A.google.cloud.managedidentities.v1.CreateMicrosoftAdDomainRequest\032\035.google.longrunning.Operation\"s\202\323\344\223\002:\"0/v1/{parent=projects/*/locations/global}/domains:\006domain\332A\031parent,domain_name,domain\312A\024\n"
          + "\006Domain\022\n"
          + "OpMetadata\022\350\001\n"
          + "\022ResetAdminPassword\022<.google.cloud.managedidentities.v1.ResetAdminPasswordRequest\032=.google.cloud.managedidentities.v1.ResetAdminPasswordResponse\"U\202\323\344\223\002H\"C/v1/{name=projects/*/locations/global/domains/*}:resetAdminPassword:\001*\332A\004name\022\277\001\n"
          + "\013ListDomains\0225.google.cloud.managedidentities.v1.ListDomainsRequest\0326.google.cloud.managedidentities.v1.ListDomainsResponse\"A\202\323\344\223\0022\0220/v1/{parent=projects/*/locations/global}/domains\332A\006parent\022\254\001\n"
          + "\tGetDomain\0223.google.cloud.managedidentities.v1.GetDomainRequest\032).google.cloud.managedidentities.v1.Domain\"?\202\323\344\223\0022\0220/v1/{name=projects/*/locations/global/domains/*}\332A\004name\022\332\001\n"
          + "\014UpdateDomain\0226.google.cloud.managedidentities.v1.UpdateDomainRequest\032\035.google.longrunning.Operation\"s\202\323\344\223\002A27/v1/{domain.name=projects/*/locations/global/domains/*}:\006domain\332A\022domain,update_mask\312A\024\n"
          + "\006Domain\022\n"
          + "OpMetadata\022\314\001\n"
          + "\014DeleteDomain\0226.google.cloud.managedidentities.v1.DeleteDomainRequest\032\035.google.longrunning.Operation\"e\202\323\344\223\0022*0/v1/{name=projects/*/locations/global/domains/*}\332A\004name\312A#\n"
          + "\025google.protobuf.Empty\022\n"
          + "OpMetadata\022\320\001\n"
          + "\013AttachTrust\0225.google.cloud.managedidentities.v1.AttachTrustRequest\032\035.google.longrunning.Operation\"k\202\323\344\223\002A\"</v1/{name=projects/*/locations/global/domains/*}:attachTrust:\001*\332A\n"
          + "name,trust\312A\024\n"
          + "\006Domain\022\n"
          + "OpMetadata\022\205\002\n"
          + "\020ReconfigureTrust\022:.google.cloud.managedidentities.v1.ReconfigureTrustRequest\032\035.google.longrunning.Operation\"\225\001\202\323\344\223\002F\"A/v1/{name=projects/*/locations/global/domains/*}:reconfigureTrust:\001*\332A/name,target_domain_name,target_dns_ip_addresses\312A\024\n"
          + "\006Domain\022\n"
          + "OpMetadata\022\320\001\n"
          + "\013DetachTrust\0225.google.cloud.managedidentities.v1.DetachTrustRequest\032\035.google.longrunning.Operation\"k\202\323\344\223\002A\"</v1/{name=projects/*/locations/global/domains/*}:detachTrust:\001*\332A\n"
          + "name,trust\312A\024\n"
          + "\006Domain\022\n"
          + "OpMetadata\022\326\001\n\r"
          + "ValidateTrust\0227.google.cloud.managedidentities.v1.ValidateTrustRequest\032\035.google.longrunning.Operation\"m\202\323\344\223\002C\">/v1/{name=projects/*/locations/global/domains/*}:validateTrust:\001*\332A\n"
          + "name,trust\312A\024\n"
          + "\006Domain\022\n"
          + "OpMetadata\032T\312A"
          + " managedidentities.googleapis.com\322A.https://www.googleapis.com/auth/cloud-platformB\222\002\n"
