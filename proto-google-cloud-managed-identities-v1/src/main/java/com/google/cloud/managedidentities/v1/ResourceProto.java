...
public final class ResourceProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "0google/cloud/managedidentities/v1/resource.proto\022!google.cloud.managedidentiti"
          + "es.v1\032\037google/api/field_behavior.proto\032\031"
          + "google/api/resource.proto\032\037google/protob"
          + "uf/timestamp.proto\032\034google/api/annotations.proto\"\236\006\n"
          + "\006Domain\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\002\022J\n"
          + "\006labels\030\002"
          + " \003(\01325.google.cloud.managedidentities.v1.Domain.LabelsEntryB\003\340A\001\022 \n"
          ...
          + "\013update_time\030\014 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\022C\n"
          + "\005state\030\r"
          + " \001(\0162/.google.cloud.managedidentities.v1.Domain.StateB\003\340A\003\022\033\n"
          + "\016status_message\030\016 \001(\tB\003\340A\003\022=\n"
          + "\006trusts\030\017"
          + " \003(\0132(.google.cloud.managedidentities.v1.TrustB\003\340A\003\032-\n"
          ...
          + "\'managedidentities.googleapis.com/Domain\0228project"
          + "s/{project}/locations/{location}/domains/{domain}\"\341\006\n"
          + "\005Trust\022\037\n"
          + "\022target_domain_name\030\001 \001(\tB\003\340A\002\022K\n\n"
          + "trust_type\030\002 \001(\01622.googl"
          + "e.cloud.managedidentities.v1.Trust.TrustTypeB\003\340A\002\022U\n"
          + "\017trust_direction\030\003 \001(\01627.goo"
          + "gle.cloud.managedidentities.v1.Trust.TrustDirectionB\003\340A\002\022%\n"
          + "\030selective_authentication\030\004 \001(\010B\003\340A\001\022$\n"
          + "\027target_dns_ip_addresses\030\005 \003(\tB\003\340A\002\022#\n"
          + "\026trust_handshake_secret\030\006 \001(\tB\003\340A\002\0224\n"
          + "\013create_time\030\007 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\0224\n"
          + "\013update_time\030\010 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\022B\n"
          + "\005state\030\t"
          + " \001(\0162..google.cloud.managedidentities.v1.Trust.StateB\003\340A\003\022\036\n"
          + "\021state_description\030\013 \001(\tB\003\340A\003\022B\n"
          + "\031last_trust_heartbeat_time\030\014"
          ...
          + "BIDIRECTIONAL\020\003B\373\001\n"
          + "%com.google.cloud.managedidentities.v1B\r"
          + "ResourceProtoP\001ZRgoogle.golang.org/genproto/googleapis/cloud/managedidentities/"
          + "v1;managedidentities\252\002!Google.Cloud.Mana"
          + "gedIdentities.V1\312\002!Google\\Cloud\\ManagedI"
          + "dentities\\V1\352\002$Google::Cloud::ManagedIdentities::V1b\006proto3"
    };
    descriptor =
